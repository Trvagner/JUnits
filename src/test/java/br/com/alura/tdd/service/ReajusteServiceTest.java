...
//**TDD
//**iniciar pelo cenário de teste primeiro
//**instanciar os objetos/classes
class ReajusteServiceTest {

	private ReajusteService service;
	private Funcionario funcionario;

	//**criado na refatoração
	//**devemos chamar em cada cenário
	//para isso usamos a anotação abaixo...@BerforeEach
